...
function Matchdata1() {
  return (
    ...
    <meta name="robots" content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large"/>
     ...
     <ol>
     <li> <strong>Smriti Mandhana</strong>  - his form brilliant  and she is good batter.</li>
     <li> <strong>Yastika Bhatia</strong> beacuse mendis has keeping advantage and his record good on batting tracks</li>
     <li> <strong>Harmanpreet Kaur</strong> - he is not hitter type batsmen but he will score good runs </li>
     <li><strong> S Meghna</strong>- good form this season </li>
     </ol>
     <h4>Top All-Rounder Picks</h4>
     <ol>
     <li><strong>G Wareham</strong>- will be the best pick in all-rounder section</li>
     <li><strong>S Molineux</strong>- he can give points both with bat and ball</li>
     <li><strong>S Devine</strong>- he can give points both with bat and ball</li>
      <li><strong>N Sciver</strong>- he can give points both with bat and ball</li>
      <li><strong>Amelia Kerr</strong>- he can give points both with bat and ball</li>
      <li><strong>H Matthews</strong> will be good pick beacause he can bowl some overs</li>
     ...
     <ol>
      <li><strong>N sciver Brunt</strong>can contribute with bat and ball </li>
      <li><strong>H Matthews</strong>risky pick but you can try bowl only 2over</li>
      <li><strong>S Devine</strong>risky pick but you can try bowl only 2over</li>
     </ol>
     <h5>Fantasy Bonus tips</h5>
     <ol>
      <li>You can try Amella Kerr as a captain if bowl first</li>
