...
import { Helmet } from 'react-helmet';
 function Matchdata8() {
   return (
     <div  >
        <div className='container Match'style={{fontSize:"1.4rem",fontFamily:"sans-serif"}} >
    <Helmet>
    ...
    <meta name="robots" content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large"/>
      ...
      <h1 className='text-center' style={{fontWeight:"600",fontSize:"1.8rem"}}>SRH vs KKR IPL 2024 Dream11 Prediction</h1>
     ...
     <h2 style={{fontWeight:"500",fontSize:"1.5rem"}}>Head to Head Records</h2>
     <div>
     <table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
     ...
     <h2 style={{fontWeight:"500",fontSize:"1.5rem"}}>Pitch Report</h2>
     ...
     <h3 style={{fontWeight:"500",fontSize:"1.5rem"}}>Sunrisers Hyderabad Playing 11</h3>
     ...
     <h3 style={{fontWeight:"500",fontSize:"1.5rem"}}>Kolkata Knight Rider playing 11</h3>
     ...
     <div className="container"style={{fontSize:"1.4rem",fontFamily:'sans-serif'}}>
     <h2 style={{fontWeight:"500",fontSize:"1.5rem"}}>Top Batting Picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"500",fontSize:"1.5rem"}}>Top All-Rounder Picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"500",fontSize:"1,5rem"}}>Top Bowling Picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"500",fontSize:"1.5rem"}}>Top Captaincy picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"500",fontSize:"1.5rem"}} >Fantasy Bonus tips</h2>
     <ol>
