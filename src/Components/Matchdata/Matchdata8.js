 ...
 function Matchdata8() {
   return (
    ...
    <meta name="robots" content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large"/>
      ...
      <h1 className='text-center my-2' style={{fontWeight:"700",fontSize:"2rem"}}>SRH vs KKR IPL 2024 Dream11 Prediction</h1>
     ...
     <h2 style={{fontWeight:"700",fontSize:"1.8rem"}}>Head to Head Records</h2>
     <div>
     <table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
     ...
     <h2 style={{fontWeight:"600",fontSize:"1.7rem"}}>Pitch Report</h2>
     ...
     <h3 style={{fontWeight:"600",fontSize:"1.7rem"}}>Sunrisers Hyderabad Playing 11</h3>
     ...
     <h3 style={{fontWeight:"600",fontSize:"1.7rem"}}>Kolkata Knight Rider playing 11</h3>
     ...
     <h2 style={{fontWeight:"600",fontSize:"1.6rem"}}>Top Batting Picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"600",fontSize:"1.6rem"}}>Top All-Rounder Picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"600",fontSize:"1.6rem"}}>Top Bowling Picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"600",fontSize:"1.6rem"}}>Top Captaincy picks</h2>
     <ol>
     ...
     <h2 style={{fontWeight:"600",fontSize:"1.6rem"}} >Fantasy Bonus tips</h2>
     <ol>
