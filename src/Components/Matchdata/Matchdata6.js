...
function Matchdata6() {
  return (
    <>
    <div className='container Match ' style={{fontSize:"1.4rem"}}>
    <Helmet>
    ...
    <meta name="keywords" content="RCB vs KKR Dream11 Prediction,RCB vs CSK  Today Match,RCB vs KKR Dream11 Prediction Today Match,rcb vs csk dream11 prediction,RCB vs KKR Pitch Report" />
    <meta name="robots" content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large"/>
    </Helmet>
      <h1 className='text-center'>RCB vs KKR Dream11 Prediction,Today Match 10 IPL 2024</h1>
  ...
  <tbody>
    ...
    <tr>
      ...
      <h2>RCB vs KKR Squad:</h2>
      <ol>
        <li> <strong>RCB Playing 11:</strong><span> <p>Faf du Plessis,Virat Kholi,Rajat Patidar,Glenn Maxwell,Cameron Green,Dinesh Karthik(wk),Mayank Dagar,Mohammad Siraj,Reece Topley,Alzari Joseph,Akash Deep,Vijaykumar Vyshak</p></span> </li>
        <li> <strong>KKR Playing 11: </strong><span><p>Phil Salt,Sunil Naraine,Venkatesh Iyer,Shreyas Iyer,Nitish Rana,Ramandeep Singh,Rinku Singh,Andre Russell,Mitchell Starc,Harshit Rana,Varun Chakaravarthy,Suyesh Sharma</p></span> </li>
      </ol>
     </div>
