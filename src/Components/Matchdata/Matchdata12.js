  ...
  return (
   <>
    ...
    <meta name="robots" content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large"/>
     ...
     <p className='my-2  '>This is the match no 31 between will be played between Kolkata Knight Riders and Rajasthan Royals.The Match will be played at Eden Gardens Kolkata.The match is going to be a thriller because both the teams have good Batting power and amazing power hitters.Kolkata holds the 2nd Place in points table with 1 loss and 4 victory and on the other side Rajasthan Royals are the current table toppers with 5 victory and 1 loss.so let`see who will win in this match and collect 2 points in this action pack show. </p>
      <h3 className='trend-heading'>Kolkat Knight Riders(KKR)</h3>
      <p>In this season kolkata knight riders in good touch.kolkata knight riders won 4 matches out of their 5 matches.KKR shows great intend in this season with bat and ball they have good power hitters like Russell and Rinku in the middle order and also Kolkata have good top order batsmen. they provide excellent start in power play.that's the reason KKR holds the 2nd place in points table..</p>
      <h3 className='trend-heading'>Rajasthan Royals(RR)</h3>
      <p>Rajasthan Royals (RR) currently holds the 1st place in points table with 10 points and the reason is his great pace attack and top order.RR have good explosive batsmen in top order like yashasvi jaiswal and jos buttler with sanju samson who provide excellent start in powerplay and the pace attack take early wickets and that`s the reason Rajasthan is the current table toppers this season.</p>
