...
function Middle1() {
  return (
    ...
    <div className="feature col ">
            ...
            <img src='/images/how to win small league.png' alt="404 not found" className='img' />
            <h2 className="fs-2 text-body-emphasis my-2 ">How To Win Small League In Dream11??</h2>
            <p  style={{fontSize:'1.5rem',fontWeight:'400',fontFamily:'sans-serif'}}>If you want to win Small League in Dream11 you have to follow these tips this will defientely help you in winnings. </p> 
            <Link to='/how-win-small-league-dream11'>
    ...
    <div className="feature col ">
            ...
            <p style={{fontSize:'1.5rem',fontWeight:'400',fontFamily:'sans-serif'}}>This is the most debatable question between cricket and football which is more famous or cricket can overtake football in future.check the facts and possiblities in the blog. </p> 
    ...
    <div className="feature col ">
            ...
            <p  style={{fontSize:'1.5rem',fontWeight:'400',fontFamily:'sans-serif'}}>if you want to play <strong>fantasy cricket</strong>you have to know before playing <strong> What is fantasy Cricket</strong> </p>
          ...
          <div className="feature col ">
            ...
            <p   style={{fontSize:'1.5rem',fontWeight:'400',fontFamily:'sans-serif'}}className='my-2' >If you are a ipl fan you should check this blog should ipl banned in india or not.  </p> 
          ...
          <div className="feature col ">
            ...
            <p  style={{fontSize:'1.5rem',fontWeight:'400',fontFamily:'sans-serif'}}> if you want to Make Money from <strong>fantasy cricket</strong>you have to know before playing <strong> How You Earn money</strong>check simple steps. </p> 
          ...
          <div className="feature col ">
            ...
            <p  style={{fontSize:'1.5rem',fontWeight:'400',fontFamily:'sans-serif'}}>If you are cricket fan so this is the most asked question by cricket fans <strong>Should Cricket Be the National Game of India?</strong>here you will get your answer. </p> 
