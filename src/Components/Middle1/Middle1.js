...
function Middle1() {
  return (
    ...
    <div className="feature col ">
            ...
            <p style={{fontSize:'1.6rem',fontWeight:'450',fontFamily:'sans-serif'}}>This is the most debatable question between cricket and football which is more famous or cricket can overtake football in future.check the facts and possiblities in the blog. </p> 
    ...
    <div className="feature col ">
            ...
            <p  style={{fontSize:'1.6rem',fontWeight:'450',fontFamily:'sans-serif'}}>if you want to play <strong>fantasy cricket</strong>you have to know before playing <strong> What is fantasy Cricket</strong> </p>
          ...
          <div className="feature col ">
            ...
            <p   style={{fontSize:'1.6rem',fontWeight:'450',fontFamily:'sans-serif'}}className='my-2' >If you are a ipl fan you should check this blog should ipl banned in india or not.  </p> 
          ...
          <div className="feature col ">
            ...
            <p  style={{fontSize:'1.6rem',fontWeight:'450',fontFamily:'sans-serif'}}> if you want to Make Money from <strong>fantasy cricket</strong>you have to know before playing <strong> How You Earn money</strong>check simple steps. </p> 
          ...
          <div className="feature col ">
            ...
            <p  style={{fontSize:'1.6rem',fontWeight:'450',fontFamily:'sans-serif'}} >if you want to Make Money from <strong>fantasy cricket</strong>check the latest <strong> Fantasy Cricket Investment Plan</strong>check simple steps. </p> 
          ...
          <div className="feature col ">
            ...
            <p  style={{fontSize:'1.6rem',fontWeight:'450',fontFamily:'sans-serif'}}>check if you want to know ipl is scripted or fixed ? then please check the full blog you will get your answer. </p> 
          ...
          <div className="feature col ">
            ...
            <p  style={{fontSize:'1.6rem',fontWeight:'450',fontFamily:'sans-serif'}}>If you are cricket fan so this is the most asked question by cricket fans <strong>Should Cricket Be the National Game of India?</strong>here you will get your answer. </p> 
