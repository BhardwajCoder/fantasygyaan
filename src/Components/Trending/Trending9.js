...
function Trending9() {
    const [sections] = useState([
        ...
        { id: 'section3', title: 'Choose Your Contests' },
        { id: 'section4', title: 'Divide Your Budget' },
        { id: 'section5', title: 'Pick 1 or 2 Risky Players' },
        { id: 'section6', title: 'Try Different Captaincy Option' },
  ...
  return (
   ...
   <Helmet>
        <title>How To Win Small League In Dream11? - fantasygyaan</title>
     ...
     <h1 className='main-H1 my-2'>How To Win Small League In Dream11?</h1>
     ...
     <h2 className='trend-heading'>Tips To Win Small League in Dream11</h2>
     <ol>
     ...
     <p>In above paragraph we disscuss some tips that help you in winning small leagues.you have to follow these tips to earn profit from small leagues.small leagues are the best type of contest to earn regular profit from small leagues.In small leagues competiton is very low in comparison of big contests or grand leagues so people generally prefer small leagues and the chance of winning is very high in small leagues in comparison of risk.most of the famous fantasy cricket expert play small leagues. </p>
